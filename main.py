...
if __name__ == '__main__':
    ...
    questions = []
    survey_question_1 = SurveyQuestion("What is UI/UX like?")
    option_list = [
    ...
    survey_question_2 = SurveyQuestion("What is like?")
    option_list_2 = [
